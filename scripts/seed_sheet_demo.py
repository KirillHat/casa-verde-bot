...
LEADS: list[tuple] = [
    ...
    (
        ...
        3,
        "foreign_national",
        ["privacy", "tennis court"],
        "h.yamamoto@example.jp",
    ...
    (
        ...
        2,
        "rental",
        ["walkable to coffee", "unfurnished"],
        "schen@example.com",
...
def main() -> None:
    ...
    sheet = client.open_by_key(settings.google_sheets_id).worksheet(settings.google_sheets_tab)
